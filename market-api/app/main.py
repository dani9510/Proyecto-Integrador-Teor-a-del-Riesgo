...
# ═══════════════════════════════════════════════════════════════════
    ...
    if data_cache and valid_assets:
        ...
        if '^DJI' in data_cache["ind"] and 'log_return' in data_cache["ind"]['^DJI'].columns:
            returns_df["S&P 500"] = data_cache["ind"]["^DJI"]["log_return"]
...
# ═══════════════════════════════════════════════════════════════════
    ...
    <strong>S&P 500</strong> (^DJI), el benchmark más utilizado para medir el desempeño del mercado norteamericano.
